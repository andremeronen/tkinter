...
def main():
    ...
    # Teine sisestusväli
    label2=tk.Label(frame2, text="aasta intressimäär (%)").pack(side="left")
    ...
    sisestus3=tk.Entry(frame3).pack(side="left", fill="x", expand="true")
   
    # Nupp, mis käivitab funktsiooni kuva_sisestus
    nupp = tk.Button(frame, text="Vajuta mind", command=kuva_sisestus)
    nupp.pack(side="bottom", expand="true", fill="x")
